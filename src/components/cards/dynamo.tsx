...
export function Dynamo() {
	return Builder(
		...
		`
			...
			first day, only around 7500 men were evacuated. However, over 10,000 got out the next day.
			Since Dunkirk had a very shallow beach and Royal Navy vessels were getting bombed on the way back to
			Dover, the British sent their civilians' boats, many fishing boats, to aid in Dunkirk's
